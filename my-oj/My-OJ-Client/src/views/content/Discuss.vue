<template>
    <div>
        <h1 class="h3 mb-3">Discussing</h1><br>
...
export default {
    ...
    mounted() {
        if(this.$route.params.num !== undefined){
            this.$router.push({name: 'topic', params: {num: this.$route.params.num, floor: this.$route.params.floor}});
            //console.log(this.$route.params.num + " " + this.$route.params.floor);
            return;
        }
        this.$axios.post('/getAllTopic').then(response => {
