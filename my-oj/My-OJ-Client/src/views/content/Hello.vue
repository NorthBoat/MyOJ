                    ...
                    <div class="card-body py-3">
                        <div class="block" style="text-align: center">
                            <el-carousel trigger="click" height="252px">
                                <el-carousel-item v-for="item in this.carousel" :key="item">
                ...
                <div class="card flex-fill w-100">
                    ...
                    <div class="card-body d-flex">
                        <div class="align-self-center w-100">
                            ...
                            <el-progress :text-inside="true" :stroke-width="25" :percentage="this.percent.go" color="pink"></el-progress><br><br>
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Golang</td>
                                        <td class="text-right">{{this.news.go_using}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
export default {
    ...
    methods: {
        ...
        setPercent(){
            let tatol = this.news.java_using + this.news.c_using + this.news.go_using;
            ...
            this.percent.go = this.fixingPercent(this.news.go_using / tatol);
        },
