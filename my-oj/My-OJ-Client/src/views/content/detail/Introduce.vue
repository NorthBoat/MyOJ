...
export default {
    ...
    mounted() {
        ...
        if(this.$route.params.result !== undefined){
            this.$router.push({name: 'result', params: {result: this.$route.params.result, code: this.$route.params.code}});
            //console.log(this.$route.params.result);
            return;
        } else if(this.$route.params.floor != undefined){
            this.$router.push({name: 'comment', params: {floor: this.$route.params.floor}});
            return;
        }
