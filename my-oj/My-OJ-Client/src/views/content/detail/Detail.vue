            ...
            <el-dropdown style="margin-bottom: 9px" @command="choseLang">
              <span style="font: 16px Medium" class="el-dropdown-link">&nbsp;{{this.chose}}<i class="el-icon-arrow-down el-icon--right"></i></span>
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item command="d" disabled>Golang</el-dropdown-item>
                  </el-dropdown-menu>
            </el-dropdown> 
    ...
    methods: {
        choseLang(command){
          switch(command){
            ...
            case "d": this.lang = 30114; this.chose = 'Golang'; break;
          }
        },
        judge(){
          ...
          this.$axios.post("/judge", info).then(response=>{
              ...
              if(window.location.pathname == "/main/detail/result/" + this.question.num){
                this.$router.push({name: 'introduce', params: {result: result.data, code: this.answer}});
              } else {               
